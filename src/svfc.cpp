...
Range<Byte> output_cpp_code(grammar::Root *root, vm::LinearArena *arena, vm::LinearArena *output_arena) {
  // We rely on `vm` allocating contiguous memory.
...
int main(int argc, char *argv[]) {
  ...
  auto output_range = output::output_cpp_code(result, &arena, &output_arena);
