...
U32 const Type_dot_pointer_struct_index = 6;
U32 const Type_dot_flexible_array_struct_index = 7;
...
template<>
struct SchemaDescription::PerType<Type_dot_pointer> {
  static constexpr U64 name_hash = Type_dot_pointer_name_hash;
  static constexpr U32 index = Type_dot_pointer_struct_index;
};

template<>
struct SchemaDescription::PerType<Type_dot_flexible_array> {
  static constexpr U64 name_hash = Type_dot_flexible_array_name_hash;
  static constexpr U32 index = Type_dot_flexible_array_struct_index;
};
...
template<>
struct GetSchemaFromType<META::Type_dot_pointer> {
  using SchemaDescription = META::SchemaDescription;
};

template<>
struct GetSchemaFromType<META::Type_dot_flexible_array> {
  using SchemaDescription = META::SchemaDescription;
};
