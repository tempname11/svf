...
struct ConcreteType_dot_definedStruct;
struct ConcreteType_dot_definedChoice;
...
U32 const ConcreteType_dot_definedStruct_struct_index = 3;
U32 const ConcreteType_dot_definedChoice_struct_index = 4;
...
U64 const ConcreteType_dot_definedStruct_name_hash = 0x434B58201D8900D5ull;
U64 const ConcreteType_dot_definedChoice_name_hash = 0x4A2D7FAAEA37AF8Full;
...
union ConcreteType_union {
  ConcreteType_dot_definedStruct definedStruct;
  ConcreteType_dot_definedChoice definedChoice;
};
...
struct Type_dot_sequence {
  ConcreteType_enum elementType_enum;
  ConcreteType_union elementType_union;
};
...
struct SchemaDescription {
  ...
  static constexpr U64 content_hash = 0xE56162483B7BA057ull;
};
...
template<>
struct SchemaDescription::PerType<ConcreteType_dot_definedStruct> {
  static constexpr U64 name_hash = ConcreteType_dot_definedStruct_name_hash;
  static constexpr U32 index = ConcreteType_dot_definedStruct_struct_index;
};

template<>
struct SchemaDescription::PerType<ConcreteType_dot_definedChoice> {
  static constexpr U64 name_hash = ConcreteType_dot_definedChoice_name_hash;
  static constexpr U32 index = ConcreteType_dot_definedChoice_struct_index;
};
...
template<>
struct GetSchemaFromType<META::ConcreteType_dot_definedStruct> {
  using SchemaDescription = META::SchemaDescription;
};

template<>
struct GetSchemaFromType<META::ConcreteType_dot_definedChoice> {
  using SchemaDescription = META::SchemaDescription;
};
