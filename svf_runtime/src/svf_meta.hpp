...
struct _SchemaDescription {
  ...
  static constexpr uint32_t min_read_scratch_memory_size = 219;
  static constexpr uint32_t compatibility_work_base = 67;
  static constexpr uint64_t schema_id = 0x6DADEAAEE49D6D18ull;
  static constexpr uint64_t content_hash = 0x6C539EFA421B06BBull;
};
