...
int main(int /*argc*/, char */*argv*/[]) {
  ...
  // Fail, when a choice tag is not in the schema.
  {
    ...
    ASSERT(read_result.error_code == SVFRT_code_conversion__bad_choice_tag);
  }
